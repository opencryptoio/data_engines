...
all_senior_developers = db.developer.find()
...
db.new_developers_per_chain_per_mo.drop()

for index, element in df_data_senior_devs_month.iterrows():

    db.new_developers_per_chain_per_mo.insert_one({'chain': element['classification'], 'first_date': element['first_date'], 'new_developers': element['developer']}) 